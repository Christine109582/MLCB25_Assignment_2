# Feature_selection_rncv.py

import pandas as pd
import numpy as np
from sklearn.feature_selection import SelectKBest, f_classif, mutual_info_classif, RFE
from sklearn.linear_model import LogisticRegression
from rncv import RepeatedNestedCV # Make sure to import the class
...
# Feature Selection (done once, on whole dataset – OK if just for exploration)
...
X_selected = df[selected_features].values  # No scaling here
y_array = df['diagnosis'].values # Convert y to NumPy array
...
# Run rnCV
# Pass the NumPy array version of y to RepeatedNestedCV
rncv = RepeatedNestedCV(X_selected, y_array, estimators, param_spaces, R=10, N=5, K=3, random_state=42)
